...
interface Props {
  ...
  isLogin?: boolean;
  setIsSubmmited?: React.Dispatch<React.SetStateAction<boolean>>;
  isSubmmited?: boolean;
}
...
export const EmailSendButton = ({
  ...
  return (
    ...
    >
      {isSubmmited ? '중복 확인..' : '이메일 인증'}
    </span>
  );
};

export const CodeCheckButton = ({
  email,
  code,
  setError,
  setSuccessFlag,
